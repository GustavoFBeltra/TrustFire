            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <p className="text-foreground/70">
                  <strong className="text-foreground">ATF Compliant:</strong> All transfers facilitated through licensed FFLs in accordance with federal firearms regulations.
                </p>
              </div>
              <div className="flex gap-3">
                <span className="text-primary">✓</span>
                <p className="text-foreground/70">
                  <strong className="text-foreground">Background Checks:</strong> NICS background checks conducted by FFLs for every transfer.
                </p>
              </div>
              <div className="flex gap-3">
                <span className="text-primary">✓</span>
                <p className="text-foreground/70">
                  <strong className="text-foreground">State Regulations:</strong> Platform accounts for state-specific laws and waiting periods.
                </p>
              </div>
              <div className="flex gap-3">
                <span className="text-primary">✓</span>
                <p className="text-foreground/70">
                  <strong className="text-foreground">Age Verification:</strong> Strict enforcement of federal age requirements (18+ for long guns, 21+ for handguns).
                </p>
              </div>
              <div className="flex gap-3">
                <span className="text-primary">✓</span>
                <p className="text-foreground/70">
                  <strong className="text-foreground">Record Keeping:</strong> Digital documentation maintained in accordance with ATF requirements.
                </p>
              </div>
            </div>
          </div>
